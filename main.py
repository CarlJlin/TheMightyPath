...
import pygame
from config import screen, font, draw_text, WHITE, BLACK, player_image, player_rect, background_image, particle_image
import base64
...
def save_game(player1):
    data = f"{player1.name},{player1.surname},{player1.character.__class__.__name__},{player1.difficulty.name}\n"
...
def load_game():
    try:
        with open('save', 'r') as f:
            ...
            name, surname, character_class, difficulty = data.strip().split(',')
