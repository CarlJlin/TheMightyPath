...
public:
	static const statType baseAttack = (statType)10u;
	static const statType AttackGrowth = (statType)1.5;
	...
	Mage() : hp(baseHP, HPGrowth), statBlock(baseAttack, baseHP, baseRes, baseMana, baseMP, baseAgi) {
